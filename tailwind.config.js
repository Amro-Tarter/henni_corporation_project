...
export default {
	...
	safelist: [
		...
		'bg-red', 'bg-red-accent', 'bg-red-soft',
		...
		'hover:bg-red', 'hover:bg-red-accent', 'hover:bg-red-soft',
		...
		'border-red', 'border-red-accent', 'border-red-soft',
		...
		'text-red', 'text-red-accent', 'text-red-dark',
		...
		'ring-red', 'ring-red-accent', 'ring-red-soft',
