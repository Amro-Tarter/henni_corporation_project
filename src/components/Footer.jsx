        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3 text-white/80">
              <li><a href="#what-we-do" className="hover:text-theme-bg-secondary transition-colors duration-200">מיזמים חינוכיים</a></li>
              <li><a href="#our-vision" className="hover:text-theme-bg-secondary transition-colors duration-200">החזון שלנו</a></li>
              <li><a href="#join-us" className="hover:text-theme-bg-secondary transition-colors duration-200">הצטרפו אלינו</a></li>
              <li>
                <a
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3 text-white/80">
              <li><Link to="/accessibility" className="hover:text-theme-bg-secondary transition-colors duration-200">הצהרת נגישות</Link></li>
              <li><Link to="/privacy" className="hover:text-theme-bg-secondary transition-colors duration-200">הצהרת פרטיות</Link></li>
              <li><Link to="/terms" className="hover:text-theme-bg-secondary transition-colors duration-200">תנאי שימוש</Link></li>
            </ul>
          </div>
