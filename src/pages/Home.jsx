...
const Home = () => {
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, async (authUser) => {
      ...
      // 1) Build fullUser with basic auth info + username from users/{uid}
      ...
      // 2) Fetch profile doc by UID (so we get element, photoURL, etc.)
  ...
  // Show loader until profile and posts are ready
