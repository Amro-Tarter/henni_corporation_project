...
const ELEMENTS = [
  ...
  { key: 'air', emoji: '💨', title: 'קורסי אוויר', description: 'תכנים המעודדים חשיבה יצירתית, מדיטציה ותודעה.', color: 'from-blue-200 to-cyan-20', lightColor: 'bg-blue-100', sound: '/sounds/air.mp3' },
  { key: 'water', emoji: '💧', title: 'קורסי מים', description: 'תכנים העוסקים ברגש, ביטוי אישי וזרימה פנימית.', color: 'from-indigo-500 to-cyan-100', lightColor: 'bg-indigo-100', sound: '/sounds/water.mp3' },
